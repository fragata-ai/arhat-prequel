...
and saves parameters of the trained model in a file.

Usage:

    mkdir -p bin
    mkdir -p mnist_saveprm
    go build -o bin/mnist_saveprm fragata/arhat/examples/mnist_saveprm
    bin/mnist_saveprm -o mnist_saveprm
*/
...
func Main(engine *util.Engine) {
    ...
    mlp.SaveParams("params/mnist_mlp.prm")
}
