...
/*
Small convolutional neural network on CIFAR10 data.

Usage:

    mkdir -p bin
    mkdir -p cifar10_conv
    go build -o bin/cifar10_conv fragata/arhat/examples/cifar10_conv
    bin/cifar10_conv -o cifar10_conv
*/
